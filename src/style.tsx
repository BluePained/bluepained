...
const backgroundNav = "#080e25";
const backgroundDrawer = "#0a0b0f";
const backgroundTab = "#fef844";
const backgroundTabSecondary = "#0f121c";
const backgroundDivider = "#7800f8";
const backgroundCard = "#171a25";
// Warning Colors
  ...
  */
  palette: {
    ...
    background: {
      ...
      tab: backgroundTab,
      tabSecondary: backgroundTabSecondary,
      divider: backgroundDivider,
      card: backgroundCard
    },
    warning: {
      main: warning,
